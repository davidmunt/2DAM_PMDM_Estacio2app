...
import 'package:mejora_robot/presentation/widgets/alert_respuesta.dart';
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  String mensajeRespuesta =
                      "Robot actualizado con el nombre ${nombre}";
                  if (!_formKey.currentState!.validate()) {
                    mensajeRespuesta = "Algun campo no es válido";
                  }
                  // Llamamos a la nueva clase para mostrar el diálogo
                  AlertRespuesta.mostrar(context: context, respuesta: mensajeRespuesta);
                },
